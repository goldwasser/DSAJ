...
public class ArrayList<E> implements List<E> {
     ...
     * @param n one greater than the maximum allowable index
     * @throws IndexOutOfBoundsException if the index is negative or greater than n
     */
    ...
    private class ArrayIterator implements Iterator<E> {
        ...
        public E next() throws NoSuchElementException {
            ...
            return data[j++];   // post-increment j, so it is ready for subsequent call to next
        }
