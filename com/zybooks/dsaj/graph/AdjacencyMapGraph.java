 ...
 *
 * @param <V> Associated data stored with a vertex
 * @param <E> Associated data stored with an edge
 *
...
public class AdjacencyMapGraph<V,E> implements Graph<V,E> {
     ...
     * @param directed true if a directed graph, false if an undirected graph
     */
